				...
				<table class="table table-responsive">
					...
					<c:forEach var="cliente" items="${clientes}">
						<tr>
							...
							<td><a href="form-atualiza-cliente?telefone=${cliente.telefone}"><span class="glyphicon glyphicon-pencil"></span></a></td>
							<td><a href="remover-cliente?telefone=${cliente.telefone}"><span class="glyphicon glyphicon-trash"></span></a></td>				
						</tr>
					</c:forEach>
				</table>
			</div>
