...
<div class="center-block container">
    ...
    <form class="form-horizontal center-m" action="atualizar-cliente" method="post">
    ...
    <div id="mensagem" class="alert alert-info">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input readonly type="text" class="form-control" name="nome" value="${cliente.nome}">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">Telefone</label>
            <div class="col-sm-10">
                <input readonly type="text" class="form-control"  name="telefone" value="${cliente.telefone}">
            </div>
    	</div>
    ...
    <div id="mensagem" class="alert alert-info">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">Nome</label>
            <div class="col-sm-10">
                <input required type="text" class="form-control" id="nome" name="nome_novo">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">Telefone</label>
            <div class="col-sm-10 col-md-5">
                <input required type="text" class="form-control" id="telefone" name="telefone_novo">
            </div>
