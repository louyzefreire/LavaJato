...
<div class="panel panel-default">
      <div class="panel-heading">
   			 <h3 class="panel-title">Cadastro de veículo</h3>
  	  </div>
     <div class="panel-body">
<form class="form-horizontal center-m" action="cadastrar-veiculo" method="get">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input required type="text" class="form-control" id="placa" name="placa" placeholder="AAA-1234">
            </div>
        </div>
        <div class="form-group">
